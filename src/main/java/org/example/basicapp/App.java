...
public class App 
{
	...
	{
		System.out.println("Availavle Zones....");
	...
	public static void startinstance()
	{
		...
		String instance_id = input_id.next();
	...
	public static void stopinstance()
	{
		...
		System.out.println("Stop Instance ID :");
		Scanner input_id = new Scanner(System.in);
		String instance_id = input_id.next();
	...
	{
		System.out.println("Reboot Instance ID :");
		Scanner input_id = new Scanner(System.in);
		String instance_id = input_id.next();
